...
module.exports = {
  ...
  //       ctx.state.user.id
  //     );
  //     const usdtRate = await strapi.services.rate.getRate(
  ...
  //       amount: bonus * usdtRate,
  //       unit: strapi.models.transaction.USDT,
  ...
  //       `User ${ctx.state.user.accountNumber} earns ${
  //         bonus * usdtRate
  //       } USDT as Daily interest.`,
  //       ctx.state.user
  //     );
